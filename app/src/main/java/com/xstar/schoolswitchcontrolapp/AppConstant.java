...
public class AppConstant {
    ...
    public static final String  PROJECTOR_IP = "192.168.1.15";
    public static final int PROJECTOR_PORT = 8000;

    public static final String  LEFT_TV_IP = "192.168.1.10";
    public static final int LEFT_PORT = 8000;

    public static final String  RIGHT_TV_IP = "192.168.1.14";
    public static final int RIGHT_PORT = 8000;

    public static final String  M_SCREEN_IP = "192.168.1.16";
    public static final int M_SCREEN_PORT = 8000;

    public static final int WALL_HDMI = 0;
